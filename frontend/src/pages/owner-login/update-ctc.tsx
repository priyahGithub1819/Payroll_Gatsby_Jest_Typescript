...
function App() {
  ...
  const [selectedTable, setSelectedTable] = useState<"fte" | "pte" | "intern" | null>(null); // Added state for selected table
                    ...
                    <tbody>
                      {records &&
                        records.map((record: EmployeeData, Index: number) => {
                          if (record.basic.employmentType ==="FTE")
                            return (
                              <tr key={Index}>
                                <td></td>
                ...
                <div className="empTable">
                  ...
                  <thead>
                    ...
                    <tbody>
                      {records &&
                        records.map((record: EmployeeData, Index: number) => {
                          if (record.basic.employmentType ==="PTE")
                            return (
                              <tr key={Index}>
                                <td></td>
                                <td>{record.payrollData.empId}</td>
