      ...
      <div className="container-fluid pfEnrolledListContainer">
        <div className="row justify-content-center">
          <div className="col-lg-12" >
            ...
            <h2 className="text-center mb-4" data-testid="heading">List of Exited PF Employees </h2>

            <div className="empTable col-lg-12">
              <table className="table table-bordered css-serial" data-testid="table">
                <thead>
                  <tr>
                    <th className="heading" role="column">Sr. No.</th>
                    <th className="heading"  role="column">Name of Employee</th>
                    <th className="heading"  role="column">
                      Date Of Birth (Mentioned on Aadhar card.)
                    </th>
                    <th className="heading"  role="column">Employee Id</th>
                    <th className="heading"  role="column">Aadhar Number</th>
                    <th className="heading"  role="column">Pan Number</th>
                    <th className="heading"  role="column">Bank Name</th>
                    <th className="heading"  role="column">IFSC Code</th>
                    <th className="heading"  role="column">Account number</th>
                    <th className="heading"  role="column">Address</th>
                    <th className="heading"  role="column">Date of registration</th>
                    <th className="heading"  role="column">PF UAN Number</th>
                    <th className="heading"  role="column">Joining Date</th>
                    <th className="heading"  role="column">Last Working Day</th>
                    <th className="heading"  role="column">Deletion Date and User EmpId</th>
                  </tr>
                </thead>
                <tbody>
