...
const routes = [
  ...
  { path: "/Owner/addCTC", component: () => <h1>add CTC page</h1> },
  { path: "/Owner/updateCTC", component: () => <h1>update CTC page</h1> },
  {
...
describe("testing Owner.tsx", () => {
  ...
  it("checking is Employee Record Update is working", async () => {
    ...
    const targetBtn = screen.getByTestId("empRecordUpdate");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
  ...
  it("checking is Candidate Selection is working", async () => {
    ...
    const targetBtn = screen.getByTestId("candiSelection");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
  ...
  it("checking is View Candidate Selection is working", async () => {
    ...
    const targetBtn = screen.getByTestId("viewSelectedCandi");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
  ...
  it("checking is View Reject Candidate page is working", async () => {
    ...
    const targetBtn = screen.getByTestId("viewRejectedCandi");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
  ...
  it("checking is View Onboarding Candidate page is working", async () => {
    ...
    const targetBtn = screen.getByTestId("viewOnboardCandi");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
  ...
  it("checking is Add CTC page is working", async () => {
    ...
    const targetBtn = screen.getByTestId("addCTC");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
  ...
  it("checking is Update CTC page is working", async () => {
    ...
    const targetBtn = screen.getByTestId("updateCTC");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
  ...
  it("checking is Upload Payroll Document page is working", async () => {
    ...
    const targetBtn = screen.getByTestId("uploadPayrollDoc");
    userEvent.click(targetBtn);
    cleanup();
    multiRender(routes, {
      path: `${targetBtn.getAttribute("href")}`,
